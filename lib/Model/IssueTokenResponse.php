...
/**
 * IssueTokenResponse Class Doc Comment
 *
 * @category Class
 * @package  NeblioAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class IssueTokenResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'issueTokenResponse';
     ...
     * Sets token_id
     *
     * @param string|null $token_id TokenId of the to be issued token
     *
     * @return $this
     */
     ...
     * Sets tx_hex
     *
     * @param string|null $tx_hex Unsigned, raw transaction hex of the transaction to issue the token
     *
     * @return $this
     */
