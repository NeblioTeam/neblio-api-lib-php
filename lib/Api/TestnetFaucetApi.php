...
class TestnetFaucetApi
{
     ...
     * @return \Swagger\Client\Model\GetFaucetResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetFaucetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function testnetGetFaucetWithHttpInfo($address, $amount = null)
    {
        $returnType = '\Swagger\Client\Model\GetFaucetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetFaucetResponse',
