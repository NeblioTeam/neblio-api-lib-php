...
class TestnetNTP1Api
{
     ...
     */
    public function testnetGetTokenMetadata($tokenid)
    {
        list($response) = $this->testnetGetTokenMetadataWithHttpInfo($tokenid);
        return $response;
    }
     ...
     */
    public function testnetGetTokenMetadataWithHttpInfo($tokenid)
    {
        $request = $this->testnetGetTokenMetadataRequest($tokenid);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testnetGetTokenMetadataAsync($tokenid)
    {
        return $this->testnetGetTokenMetadataAsyncWithHttpInfo($tokenid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testnetGetTokenMetadataAsyncWithHttpInfo($tokenid)
    {
        $returnType = '\NeblioAPI\Model\GetTokenMetadataResponse';
        $request = $this->testnetGetTokenMetadataRequest($tokenid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testnetGetTokenMetadataRequest($tokenid)
    {
        // verify the required parameter 'tokenid' is set
        if ($tokenid === null || (is_array($tokenid) && count($tokenid) === 0)) {
            throw new \InvalidArgumentException(
