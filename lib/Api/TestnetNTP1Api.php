...
class TestnetNTP1Api
{
    ...
    /**
     * Operation testnetGetTokenMetadata
     *
     ...
     */
    public function testnetGetTokenMetadata($tokenid, $verbosity = null)
    {
        list($response) = $this->testnetGetTokenMetadataWithHttpInfo($tokenid, $verbosity);
        return $response;
    }

    /**
     * Operation testnetGetTokenMetadataWithHttpInfo
     *
     * Get Metadata of Token
     *
     * @param  string $tokenid TokenId to request metadata for (required)
     ...
     */
    public function testnetGetTokenMetadataWithHttpInfo($tokenid, $verbosity = null)
    {
        $request = $this->testnetGetTokenMetadataRequest($tokenid, $verbosity);
    ...
    /**
     * Operation testnetGetTokenMetadataAsync
     *
     * Get Metadata of Token
     *
     * @param  string $tokenid TokenId to request metadata for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testnetGetTokenMetadataAsync($tokenid, $verbosity = null)
    {
        return $this->testnetGetTokenMetadataAsyncWithHttpInfo($tokenid, $verbosity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation testnetGetTokenMetadataAsyncWithHttpInfo
     *
     * Get Metadata of Token
     *
     * @param  string $tokenid TokenId to request metadata for (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testnetGetTokenMetadataAsyncWithHttpInfo($tokenid, $verbosity = null)
    {
        $returnType = '\NeblioAPI\Model\GetTokenMetadataResponse';
        $request = $this->testnetGetTokenMetadataRequest($tokenid, $verbosity);
    ...
    /**
     * Create request for operation 'testnetGetTokenMetadata'
     *
     * @param  string $tokenid TokenId to request metadata for (required)
     * @param  float $verbosity 0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testnetGetTokenMetadataRequest($tokenid, $verbosity = null)
    {
        // verify the required parameter 'tokenid' is set
        if ($tokenid === null || (is_array($tokenid) && count($tokenid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tokenid when calling testnetGetTokenMetadata'
            );
        }
     ...
     * @return \NeblioAPI\Model\GetTokenMetadataResponse|\NeblioAPI\Model\Error
     */
    public function testnetGetTokenMetadataOfUtxo($tokenid, $utxo, $verbosity = null)
    {
        list($response) = $this->testnetGetTokenMetadataOfUtxoWithHttpInfo($tokenid, $utxo, $verbosity);
        return $response;
    }
     ...
     * @return array of \NeblioAPI\Model\GetTokenMetadataResponse|\NeblioAPI\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function testnetGetTokenMetadataOfUtxoWithHttpInfo($tokenid, $utxo, $verbosity = null)
    {
        $request = $this->testnetGetTokenMetadataOfUtxoRequest($tokenid, $utxo, $verbosity);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testnetGetTokenMetadataOfUtxoAsync($tokenid, $utxo, $verbosity = null)
    {
        return $this->testnetGetTokenMetadataOfUtxoAsyncWithHttpInfo($tokenid, $utxo, $verbosity)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testnetGetTokenMetadataOfUtxoAsyncWithHttpInfo($tokenid, $utxo, $verbosity = null)
    {
        $returnType = '\NeblioAPI\Model\GetTokenMetadataResponse';
        $request = $this->testnetGetTokenMetadataOfUtxoRequest($tokenid, $utxo, $verbosity);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testnetGetTokenMetadataOfUtxoRequest($tokenid, $utxo, $verbosity = null)
    {
        // verify the required parameter 'tokenid' is set
        if ($tokenid === null || (is_array($tokenid) && count($tokenid) === 0)) {
            throw new \InvalidArgumentException(
