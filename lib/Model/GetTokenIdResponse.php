...
class GetTokenIdResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'getTokenIdResponse';
     ...
     * Sets token_id
     *
     * @param string $token_id Unique ID of the token
     *
     * @return $this
     */
     ...
     * Sets token_name
     *
     * @param string $token_name String representing the token Symbol
     *
     * @return $this
     */
