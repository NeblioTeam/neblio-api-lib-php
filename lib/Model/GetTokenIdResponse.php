...
/**
 * GetTokenIdResponse Class Doc Comment
 *
 * @category Class
 * @package  NeblioAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetTokenIdResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTokenIdResponse';
     ...
     * Sets token_id
     *
     * @param string|null $token_id Unique ID of the token
     *
     * @return $this
     */
     ...
     * Sets token_name
     *
     * @param string|null $token_name String representing the token Symbol
     *
     * @return $this
     */
