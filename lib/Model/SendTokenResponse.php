...
class SendTokenResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sendTokenResponse';
     ...
     * Sets tx_hex
     *
     * @param string $tx_hex Unsigned, raw transaction hex of the transaction to send the token
     *
     * @return $this
     */
     ...
     *
     * @param float[] $ntp1_output_indexes Array of indexes transfering NTP1 tokens
     *
     * @return $this
     */
     ...
     *
     * @param float[] $multisig_outputs Array of indexes of multisig outputs
     *
     * @return $this
     */
