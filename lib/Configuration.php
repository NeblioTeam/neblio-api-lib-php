...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://ntp1node.nebl.io';
     ...
     * @var string
     */
    protected $userAgent = 'neblio-api-php/1.2.1';
    ...
    {
        $report  = 'PHP SDK (NeblioAPI) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.2.2' . PHP_EOL;
