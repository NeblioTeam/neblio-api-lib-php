...
class IssueTokenResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'issueTokenResponse';
     ...
     * Sets token_id
     *
     * @param string $token_id TokenId of the to be issued token
     *
     * @return $this
     */
     ...
     * Sets tx_hex
     *
     * @param string $tx_hex Unsigned, raw transaction hex of the transaction to issue the token
     *
     * @return $this
     */
