...
/**
 * GetTransactionInfoResponseTokens Class Doc Comment
 *
 * @category Class
 * @package  NeblioAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetTransactionInfoResponseTokens implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionInfoResponse_tokens';
     ...
     * Sets issue_txid
     *
     * @param string|null $issue_txid TXID the token was issued in
     *
     * @return $this
     */
