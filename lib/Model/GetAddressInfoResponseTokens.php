...
class GetAddressInfoResponseTokens implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAddressInfoResponse_tokens';
     ...
     * Sets token_id
     *
     * @param string|null $token_id Unique NTP1 identifier for this token
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Number of Tokens
     *
     * @return $this
     */
     ...
     * Sets issue_txid
     *
     * @param string|null $issue_txid TXID the token originally was issued in
     *
     * @return $this
     */
     ...
     * Sets lock_status
     *
     * @param bool|null $lock_status Whether the token is locked, preventing more from being issued
     *
     * @return $this
     */
     ...
     *
     * @param string|null $aggregation_policy Whether the tokens can be aggregated together
     *
     * @return $this
     */
