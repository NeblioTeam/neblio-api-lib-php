...
class NTP1Api
{
     ...
     *
     * @param  string $tokenid TokenId to request metadata for (required)
     * @param  float $verbosity 0 (Default) is fastest, 1 contains token stats, 2 contains token holding addresses (optional)
     *
     * @throws \NeblioAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \NeblioAPI\Model\GetTokenMetadataResponse|\NeblioAPI\Model\Error
     */
    public function getTokenMetadata($tokenid, $verbosity = null)
    {
        list($response) = $this->getTokenMetadataWithHttpInfo($tokenid, $verbosity);
        return $response;
    }
     ...
     */
    public function getTokenMetadataWithHttpInfo($tokenid, $verbosity = null)
    {
        $request = $this->getTokenMetadataRequest($tokenid, $verbosity);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTokenMetadataAsync($tokenid, $verbosity = null)
    {
        return $this->getTokenMetadataAsyncWithHttpInfo($tokenid, $verbosity)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTokenMetadataAsyncWithHttpInfo($tokenid, $verbosity = null)
    {
        $returnType = '\NeblioAPI\Model\GetTokenMetadataResponse';
        $request = $this->getTokenMetadataRequest($tokenid, $verbosity);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTokenMetadataRequest($tokenid, $verbosity = null)
    {
        // verify the required parameter 'tokenid' is set
        if ($tokenid === null || (is_array($tokenid) && count($tokenid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($verbosity !== null) {
            $queryParams['verbosity'] = ObjectSerializer::toQueryValue($verbosity);
        }
     ...
     * @return \NeblioAPI\Model\GetTokenMetadataResponse|\NeblioAPI\Model\Error
     */
    public function getTokenMetadataOfUtxo($tokenid, $utxo, $verbosity = null)
    {
        list($response) = $this->getTokenMetadataOfUtxoWithHttpInfo($tokenid, $utxo, $verbosity);
        return $response;
    }
     ...
     * @return array of \NeblioAPI\Model\GetTokenMetadataResponse|\NeblioAPI\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTokenMetadataOfUtxoWithHttpInfo($tokenid, $utxo, $verbosity = null)
    {
        $request = $this->getTokenMetadataOfUtxoRequest($tokenid, $utxo, $verbosity);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTokenMetadataOfUtxoAsync($tokenid, $utxo, $verbosity = null)
    {
        return $this->getTokenMetadataOfUtxoAsyncWithHttpInfo($tokenid, $utxo, $verbosity)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTokenMetadataOfUtxoAsyncWithHttpInfo($tokenid, $utxo, $verbosity = null)
    {
        $returnType = '\NeblioAPI\Model\GetTokenMetadataResponse';
        $request = $this->getTokenMetadataOfUtxoRequest($tokenid, $utxo, $verbosity);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTokenMetadataOfUtxoRequest($tokenid, $utxo, $verbosity = null)
    {
        // verify the required parameter 'tokenid' is set
        if ($tokenid === null || (is_array($tokenid) && count($tokenid) === 0)) {
            throw new \InvalidArgumentException(
